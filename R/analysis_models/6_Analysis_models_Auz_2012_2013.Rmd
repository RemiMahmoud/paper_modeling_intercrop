---
title: "Analysis models Auz2012-2013"
output:
...
read_and_assign <- function(path, name_to_assign_suffix = NULL) {
  print(path)
  model <- read_rds(path) 
  
  name_to_assign <- unlist(stringr::str_split(path, "\\."))[1]
  name_to_assign <- stringr::str_remove(name_to_assign, "models/Auz_2012_2013" )
...
list_models <-  list.files("models/Auz_2012_2013", recursive = TRUE, full.names = TRUE)
