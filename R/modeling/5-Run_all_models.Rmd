...
fun_call_gmerf_modified <- function(data, y = "yield_cereal", group = "experiment_id", max_iterations = 200, toll_param = 0.02, verbose_param = FALSE, list_control_lme = list(msMaxIter = 1000, msMaxEval = 1000, opt = "optim"), weights_lme = varIdent(form = ~1|group) ){
...
models_PLER_legume_wt_fababean <- data_wt_fababean_nested %>% 
  mutate(mod.gmerf = map(data, fun_call_gmerf_modified, verbose_param = TRUE, y = "PLER_legume", max_iterations = 3000)) 

models_PLER_legume_wt_fababean <- data_wt_fababean_nested %>% 
  mutate(mod.gmerf = map(data, fun_call_gmerf_modified, verbose_param = TRUE, y = "PLER_legume", max_iterations = 3000, list_control_lme = list(), weights_lme = NULL)) 
...
models_yield_total_wt_fababean <- data_wt_fababean_nested %>% 
  mutate(mod.gmerf = map(data, fun_call_gmerf_modified, verbose_param = TRUE, y = "yield_total", max_iterations = 1000)) 
...
models_CE_wt_fababean <- data_wt_fababean_nested %>% 
  mutate(mod.gmerf = map(data, fun_call_gmerf_modified, verbose_param = TRUE, y = "CE", max_iterations = 1000)) 
...
models_PLER_cereal_wt_pea <- data_wt_pea_nested %>% 
  mutate(mod.gmerf = map(data, fun_call_gmerf_modified, verbose_param = TRUE, y = "PLER_cereal")) 

```

```{r, eval = FALSE}

write_rds(models_PLER_cereal_wt_pea, "models/wt_pea/PLER_cereal_wt_pea.rds")
...
models_PLER_legume_wt_pea <- data_wt_pea_nested %>% 
  mutate(mod.gmerf = map(data, fun_call_gmerf_modified, verbose_param = TRUE, y = "PLER_legume", max_iterations = 2000, toll_param = 0.03))  

```

```{r, eval = FALSE}

write_rds(models_PLER_legume_wt_pea, "models/wt_pea/PLER_legume_wt_pea.rds")
...
models_yield_total_wt_pea <- data_wt_pea_nested %>% 
  mutate(mod.gmerf = map(data, fun_call_gmerf_modified, verbose_param = TRUE, y = "yield_total", max_iterations=  2000)) 
...
write_rds(models_LER_wt_pea, "models/wt_pea/LER_wt_pea.rds")
...
write_rds(models_BE_wt_pea, "models/wt_pea/BE_wt_pea.rds")
...
write_rds(models_CE_wt_pea, "models/wt_pea/CE_wt_pea.rds")
...
models_SE_wt_pea <- data_wt_pea_nested %>% 
  mutate(mod.gmerf = map(data, fun_call_gmerf_modified, verbose_param = TRUE, y = "SE", max_iterations = 2000))  


write_rds(models_SE_wt_pea, "models/wt_pea/SE_wt_pea.rds")
...
models_yield_cereal_all_species <- data_all_species_nested %>% 
  mutate(mod.gmerf = map(data, fun_call_gmerf_modified, verbose_param = TRUE, max_iterations = 200)) 

```

```{r, eval = FALSE}

write_rds(models_yield_cereal_all_species, "models/all_species/yield_cereal_all_species.rds")
...
write_rds(models_PLER_cereal_all_species, "models/all_species/PLER_cereal_all_species.rds")
...
models_yield_legume_all_species <- data_all_species_nested %>% 
  mutate(mod.gmerf = map(data, fun_call_gmerf_modified, verbose_param = TRUE, y = "yield_legume", max_iterations = 1000)) 
...
write_rds(models_yield_legume_all_species, "models/all_species/yield_legume_all_species.rds")
...
models_PLER_legume_all_species <- data_all_species_nested %>% 
  mutate(mod.gmerf = map(data, fun_call_gmerf_modified, verbose_param = TRUE, y = "PLER_legume", max_iterations = 2000, toll_param = 0.02))  

```

```{r, eval = TRUE}

write_rds(models_PLER_legume_all_species, "models/all_species/PLER_legume_all_species.rds")
...
write_rds(models_yield_total_all_species, "models/all_species/yield_total_all_species.rds")
...
write_rds(models_LER_all_species, "models/all_species/LER_all_species.rds")
...
models_BE_all_species <- data_all_species_nested %>% 
  mutate(mod.gmerf = map(data, fun_call_gmerf_modified, verbose_param = TRUE, y = "BE", max_iterations = 2000)) 
...
write_rds(models_BE_all_species, "models/all_species/BE_all_species.rds")
...
models_CE_all_species <- data_all_species_nested %>% 
  mutate(mod.gmerf = map(data, fun_call_gmerf_modified, verbose_param = TRUE, y = "CE", max_iterations = 2000)) 
...
write_rds(models_CE_all_species, "models/all_species/CE_all_species.rds")
...
write_rds(models_SE_all_species, "models/all_species/SE_all_species.rds")
