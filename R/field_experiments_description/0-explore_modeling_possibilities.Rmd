...
# plot_kclique(result_fababean$G, tibble_kcliques = result_fababean$tibble_kclique, dataset = data_variables_fababean, vector_kcliques = 3)

# data_variable_wt_fababean <- summary_by_kclique %>% 
#   filter(kclique_id == "6") %>% 
